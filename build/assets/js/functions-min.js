(function () {
	...
	//matomo analytics
	  ...
	  function setDate() {
	    var retval = 1;
	    jquery(".mod").change('input', function(){
	    retval = this.value;
	    console.log(retval);
	  ...
	  jquery("<div class='pop'>Population Total <span>"+ eUS(7444509223) +"</span></div>").appendTo( ".global" );
	  ...
	  jquery.getJSON( "https://pomber.github.io/covid19/timeseries.json", function(data) {
	    ...
	    //console.log(poptotalsum);
	      ...
	      jquery("<option value='"+ indexclear +"'>").appendTo( "#regionaldata>select" );
	      ...
	      jquery("<li class='mortality'>mortality<br><span class='today'><span>"+ totalpro +"%</span></span><span class='yesterday'>"+ totalpro_yes +"%</span><span class='diff-total'>"+ itotal_diff +"%</span></li>").appendTo( "."+ indexclear +"-list" );
	      jquery("<li class='active'>active<br><span class='today'><span>"+ activepro +"</span></span><span class='yesterday'>"+ activepro_yes +"</span><span class='diff-active'>"+ eUS(iactive_diff) +"</span></li>").appendTo( "."+ indexclear +"-list" );

	      jquery.each( last_element, function (key, value){
	          console.log(value);
	        jquery( "<li class='"+ indexclear +"-"+ key +"'>"+ key +"<br><span class='today'><span>"+ eUS(value) +"</span></span></li>" ).appendTo( "."+ indexclear +"-list" );

	      });

	      jquery.each( last_element_yes, function (key, value){
	        jquery("ul[class='"+ indexclear +"-list']>li[class='"+ indexclear +"-"+ key +"']").append("<span class='yesterday'>"+ eUS(value) +"</span>");
	      });

	      jquery("ul[class='"+ indexclear +"-list']>li[class='"+ indexclear +"-confirmed']").append("<span class='diff-conf'>"+ eUS(iconf_diff) +"</span>");
	      jquery("ul[class='"+ indexclear +"-list']>li[class='"+ indexclear +"-recovered']").append("<span class='diff-recov'>"+ eUS(irecov_diff) +"</span>");
	      jquery("ul[class='"+ indexclear +"-list']>li[class='"+ indexclear +"-deaths']").append("<span class='diff-death'>"+ eUS(ideath_diff) +"</span>");
	      ...
	      for (i = 0; i < data.Germany.length; i++){
	        ...
	        jquery("<div><div class='xd_gcc inner'></div><div class='xd_gcr inner'></div><div class='xd_gcd inner'></div></div>").appendTo(".graph-timeseries>.plot-confirmed").children(".xd_gcc").css("height",""+xd_gcc*2+"px").parent().children(".xd_gcr").css("height",""+xd_gcr*2+"px").parent().children(".xd_gcd").css("height",""+xd_gcd*2+"px");

	      }

	    jquery("<div class='daycount'>Day "+ i +"</div>").appendTo(".graph-timeseries>.plot-confirmed");
	    ...
	    jquery(".graph>.plot-active").css("width",""+ gca_match +"%").append("a");
	    jquery(".graph>.plot-recovered").css("width",""+ gcr_match  +"%").append("r");
	    jquery(".graph>.plot-death").css("width",""+ gcd_match +"%").append("d");
	...
	// Test Area
	    ...
	    jquery("<div class='date'>latest request - <span>"+ global_date +"</span></div>").appendTo(".headline");
	    jquery("<div class='poppro'>Population Affected<span>"+ global_pop_mort +"%</span></div>").appendTo( ".global" );
	    jquery("<div class='confirmed'>Confirmed | &delta; -1d <span>"+ eUS(global_count_conf) +" | +"+ eUS(diff_conf) +"</span></div>").appendTo( ".global" );
	    jquery("<div class='active'>Active | &delta; -1d <span>"+ eUS(global_count_active) +" | "+ pointer_a+""+ eUS(diff_activ) +"</span></div>").appendTo( ".global" );
	    jquery("<div class='recovered'>Recovered | &delta; -1d <span>"+ eUS(global_count_recov) +" | +"+ eUS(diff_recov) +"</span></div>").appendTo( ".global" );
	    jquery("<div class='deaths'>Deaths | &delta; -1d <span>"+ eUS(global_count_death) +" | +"+ eUS(diff_death) +"</span></div>").appendTo( ".global" );
	    jquery("<div class='co'>CO2 / p.a.<span>"+ eUS(co2) +" t | +"+ eUS(co2_diff) +" t</span></div>").appendTo( ".global" );
	    jquery("<div class='cot'>Trees / p.a.<span>"+ eUS(trees) +" | +"+ eUS(trees_diff) +"</span></div>").appendTo( ".global" );
	    ...
	    jquery("<div class='mort'>Mortality Rate |  &delta; -1d <span>"+ global_count_mort+"% | "+ pointer+""+ diff_mort +"%</span></div>").appendTo( ".global" );

	    jquery("span[class*=diff]").prepend(function(){
	      var fv = jquery(this).html().replace("%","").replace(/,/g, "");
	      if (fv > 0){
	        this.prepend("+");
	      }
	    ...
	    jquery("span[class*=today]").append("<span>Act</span>");
	    jquery("span[class*=diff]").append("<span>&delta;</span>");
	    jquery("span[class*=yesterday]").append("<span>-1Day</span>");


	    jquery.getJSON("https://raw.githubusercontent.com/samayo/country-json/master/src/country-by-population-density.json", function(data){
	      jquery.each(data, function( index, value ){
	        console.log(index +"-"+ value.country +"-"+ value.density);
	        if (value.density != null) {
	        jquery("li[class*='"+ value.country +"-label']").append("<span class='density'>Population density "+value.density.toFixed(2)+ " people per square kilometer</span>"); //append
	        }
	      });
	    });
	  ...
	  jquery(".search").on('input', function(){
	    var val = this.value;
	    jquery('.order-options>div').removeClass("select");
	    jquery(".regionlists>ul").removeClass("save_one");
	    jquery(".regionlists>ul").hide();
	    jquery(".regionlists>ul[class*='save_two']").show();
	    jquery(".regionlists>ul[class|='"+ val +"']").show().addClass("save_one").css("order","0");
	    if (val == '') {
	      jquery(".regionlists>ul").show().removeClass("save_one");
	    }
	    //console.log(val);
	  });
	  jquery(".compare").on('input', function(){
	    var val = this.value;
	    jquery('.order-options>div').removeClass("select");
	    jquery(".regionlists>ul").removeClass("save_two");
	    jquery(".regionlists>ul").hide();
	    jquery(".regionlists>ul[class*='save_one']").show();
	    jquery(".regionlists>ul[class|='"+ val +"']").show().addClass("save_two").css("order","2");
	    if (val == '') {
	      jquery(".regionlists>ul").show().removeClass("save_two").css("order","0");
	    }

	    //console.log(val);
	  });

	  jquery(".by-confirmed").click( function(){

	    if (jquery(this).hasClass("select")) {
	      jquery(this).removeClass("select");

	    jquery('.regionlists>ul').each(function() {
	    ...
	    var sortval = jquery(this).children('li[class*=-confirmed]').children('span').children('span').html().replace(/,/g, "");
	    jquery(this).css("order","0");
	    jquery(this).css("order","-"+ sortval +"");

	    });

	    }
	  }).append("c");
	  jquery(".by-recovered").click( function(){
	    ...
	    var sortval = jquery(this).children('li[class*=-recovered]').children('span').children('span').html().replace(/,/g, "");
	    jquery(this).css("order","0");
	    jquery(this).css("order","-"+ sortval +"");
	  ...
	  jquery(".by-active").click( function(){
	    ...
	    var sortval = jquery(this).children('li[class*=active]').children('span').children('span').html().replace(/,/g, "");
	    jquery(this).css("order","0");
	    jquery(this).css("order","-"+ sortval +"");
	  ...
	  jquery(".by-deaths").click( function(){
	    ...
	    var sortval = jquery(this).children('li[class*=-deaths]').children('span').children('span').html().replace(/,/g, "");
	    jquery(this).css("order","0");
	    jquery(this).css("order","-"+ sortval +"");
	  ...
	  jquery(".by-mortality").click( function(){
	    ...
	    var sortval = jquery(this).children('li[class*=mortality]').children('span').children('span').html().replace("%","").replace(".","");
	    jquery(this).css("order","0");
	    jquery(this).css("order","-"+ sortval +"");
